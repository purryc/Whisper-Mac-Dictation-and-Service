...
if ! command -v brew >/dev/null 2>&1; then
  notify "WhisperCPP Accurate Installer" "Homebrew is required but was not found."
  exit 1
fi
...
notify \
  "WhisperCPP Accurate Installer" \
  "Installed whisper.cpp runtime, downloaded the medium multilingual model, and switched WhisperCPP_gateway.env to the accurate profile."
